...
CREATE TABLE STOCK_MARKET_BBDD.INVENTARIO (
  ...
  CONSTRAINT fk_accion_id FOREIGN KEY (accion_id) REFERENCES STOCK_MARKET_BBDD.ACCION(accion_id)
) ENGINE=INNODB;
...
CREATE TABLE STOCK_MARKET_BBDD.CAPA (
  ...
  PRIMARY KEY (capa_id),
  CONSTRAINT fk_accionid_capa FOREIGN KEY (accion_id) REFERENCES STOCK_MARKET_BBDD.ACCION(accion_id),
  CONSTRAINT fk_emisoroid_capa FOREIGN KEY (emisora_id) REFERENCES STOCK_MARKET_BBDD.EMISORA(emisora_id)
) ENGINE=INNODB;
...
CREATE TABLE STOCK_MARKET_BBDD.TRANSACCION (
  ...
  CONSTRAINT fk_capaid_transaccion FOREIGN KEY (capa_id) REFERENCES STOCK_MARKET_BBDD.CAPA(capa_id),
  CONSTRAINT fk_movimientoid_transaccion FOREIGN KEY (movimiento_id) REFERENCES STOCK_MARKET_BBDD.MOVIMIENTO(movimiento_id)
) ENGINE=INNODB;
